<footer class="footer">
  <div class="container">
    <div class="footer__wrap">
      ...
      <div class="footer__col">
        ...
        <div class="footer__list">
          ...
          <a href="" class="footer__link vk">
            <svg>
              <use xlink:href="<?php echo IMAGES_PATH . 'sprite.svg#vk' ?>"></use>
            </svg>
            <span>Vkontakte</span>
          </a>
          <a href="" class="footer__link youtube">
            <svg>
    ...
    <div class="footer__copy">2023 © RUSROZA.RU - питомник саженцев роз. Доставка по всей России. Все права защищены.</div>
  </div>
</footer>
