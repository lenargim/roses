...
?>
<a href="<?php echo esc_url($button_url); ?>" class="wishsuite-btn-exist <?php echo esc_attr($button_class); ?>"
   data-product_id="<?php echo esc_attr($product_id); ?>"><?php echo __($svg, 'wishsuite'); ?></a>