  ...
  <div class="container">
    ...
    <div class="about__wrap">
      <div class="about__images">
        <img src="<?php echo IMAGES_PATH . 'about1.jpg' ?>" alt="">
        <img src="<?php echo IMAGES_PATH . 'about2.jpg' ?>" alt="">
        <img src="<?php echo IMAGES_PATH . 'about3.jpg' ?>" alt="">
      </div>
      <div class="about__text">
        <p class="about__paragraph">Наши саженцы — это высококачественные растения, выращенные с любовью и забото в нашем питомнике.
