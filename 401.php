  ...
  <div class="not-found__wrap">
    <div class="not-found__text">
      ...
      <div class="not-found__desc">Пользователь не найден. Проверьте правильность заполнения полей или
        <a href="<?php echo get_permalink(get_page_by_path('sign-in'));?>">зарегестрируйтесь</a>.<br>Вы также можете вернуться на главную страницу и продолжить без регистрации.
      </div>
